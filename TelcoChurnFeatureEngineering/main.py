...
#Story Of Telcon Churn
#The telco customer churn data contains information about a fictional telecom
# company that provided home phone and internet services to 7043 customers in California
# during the third quarter, showing which customers left, stayed, or subscribed to the services.
...
##################################
# DETECTION OF NUMERICAL AND CATEGORICAL
##################################
...
# Note: Numerical variables that appear categorical are also included in the categorical variables.
...
# It is observed that "TotalCharges" is highly correlated with monthly charges and tenure
...
# SEGREGATION OF VARIABLES BY THEIR TYPES
cat_cols, num_cols, cat_but_car = grab_col_names(df)
