...
#Bu kod satırı, bir sınıflandırma modeli olan cart_model kullanılarak
# veri seti X üzerinde tahminlerin oluşturulmasını sağlar ve bu tahminleri
# y_pred değişkenine kaydeder.
